...
import { StrategiesTypes, IMsgDeriveRsaKeys_request, IMsgDeriveRsaKeys_response } from "../../../_common"

// import { setupDiffieHellman } from "./utilities"

const isGenerateCipherKey = (data: any): data is IMsgDeriveRsaKeys_request => data?.type === StrategiesTypes.derive_rsa_keys;


export const deriveRsaKeys = async (data: any): Promise<IMsgDeriveRsaKeys_response> => {
