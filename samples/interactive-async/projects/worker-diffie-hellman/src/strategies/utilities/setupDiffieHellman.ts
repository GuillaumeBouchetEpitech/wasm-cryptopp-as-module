...
export const setupDiffieHellman = (diffieHellmanClient: wasmCryptoppJs.DiffieHellmanClientJs): string => {
  diffieHellmanClient.generateKeys(localP, localQ, localG);
  return diffieHellmanClient.getPublicKeyAsHexStr();
};
