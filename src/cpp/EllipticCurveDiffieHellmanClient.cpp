...
EllipticCurveDiffieHellmanClient::EllipticCurveDiffieHellmanClient()
{
  // CryptoPP::OID CURVE = CryptoPP::ASN1::secp256r1();
  CryptoPP::OID CURVE = CryptoPP::ASN1::secp521r1();
  // CryptoPP::OID CURVE = CryptoPP::ASN1::sect571r1();
  _dh = CryptoPP::ECDH<CryptoPP::ECP>::Domain(CURVE);
}

// void EllipticCurveDiffieHellmanClient::generateRandomKeysSimpler()
// {
//   AutoSeededRandomPool rng;
//   generateRandomKeys(rng, tmpP, tmpQ, tmpG);
// }

// void EllipticCurveDiffieHellmanClient::generateRandomKeys(AutoSeededRandomPool& rng, const std::string& inP, const std::string& inQ, const std::string& inG)
void EllipticCurveDiffieHellmanClient::generateRandomKeys(AutoSeededRandomPool& rng)
{
...
void EllipticCurveDiffieHellmanClient::computeSharedSecretFromHexStr(const std::string& inHexOtherPublic)
{
...
std::string EllipticCurveDiffieHellmanClient::getPublicKeyAsHexStr() const
{
...
std::string EllipticCurveDiffieHellmanClient::getSharedSecretAsHexStr() const
{
